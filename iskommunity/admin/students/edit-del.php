            ...
            <div class="content">
                ...
                <div class="content-sidebar-form">
                    ...
                    <form action="" method="post">
                        ...
                        <br>
                        <p>To delete <strong><?php echo $student_username?></strong>, enter current admin's password for verification.</p>
                        <br>   
                        ...
                        <div class="buttons">
                            <button type="submit" name="edit-stud-del">Delete Account</button>
